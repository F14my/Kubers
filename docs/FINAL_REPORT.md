...
*(Место для вставки скриншотов)*
- Скриншот 1: Argo CD Dashboard с работающими приложениями.
- Скриншот 2: Список Pods в namespace messager-prod.
- Скриншот 3: Результат выполнения kubectl get pv,pvc.
- Скриншот 4: Интерфейс мессенджера с загруженным файлом.
